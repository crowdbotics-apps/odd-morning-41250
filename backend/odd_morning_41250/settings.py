"""
Django settings for odd_morning_41250 project.
...
ROOT_URLCONF = 'odd_morning_41250.urls'
...
WSGI_APPLICATION = 'odd_morning_41250.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_morning_41250 API",
    "DESCRIPTION": "API documentation for odd_morning_41250 App",
    "VERSION": "v1",
}
